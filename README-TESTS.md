...
- **Tiered Tool Exposure**: `CRUNCHER_TOOL_SET` env var (minimal/standard/full) — controls
  how many tools are exposed to reduce context token usage (v1.2.19)
...
### 📊 Test Statistics
- **Total Tests**: 221
- **Pass Rate**: **100%** (221/221) on v1.2.19
...
**Server Version Tested**: Cruncher **v1.2.19** (221 tests, 100% pass rate)
