...
[![Version](https://img.shields.io/badge/version-1.2.28-blue.svg)](https://github.com/islobodan/cruncher-mcp)
...
1.  **Initialization**: On startup, the server listens for an `initialize` request from the MCP client and responds with its capabilities and version info (`v1.2.28`).
