...
[![Version](https://img.shields.io/badge/version-1.2.16-blue.svg)](https://github.com/)
...
1.  **Initialization**: On startup, the server listens for an `initialize` request from the MCP client and responds with its capabilities and version info (`v1.2.16`).
